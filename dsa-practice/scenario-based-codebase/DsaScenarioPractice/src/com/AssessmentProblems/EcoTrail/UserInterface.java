...
public class UserInterface {
	public static void main(String[] args) {
		...
		Map<String, Long> mp = tu.getHikeCountByRegion(region, hikeCount);
	    ...
	    Map<String, List<Trail>> topMap = tu.getTopTrailsByRegion(n);

	    for(String region2: topMap.keySet()) {

		    System.out.println(region2);

		   for(Trail e: topMap.get(region2)) {
		    ...
		    System.out.println(
		        ...
		        e.getRegion() + " | " +
		        e.getDifficulty() + " | " +
		        e.getHikeCount() + " hikes"
		    );
		}


	    System.out.println("Difficulty statistics");
	    Map<String, String> statsMap = tu.getDifficultyStats();

	    for(String d: statsMap.keySet()) {
	    	System.out.println(d + ": " + statsMap.get(d));
	    }
